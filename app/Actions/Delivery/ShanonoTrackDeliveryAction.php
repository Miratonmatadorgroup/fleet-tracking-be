...
use App\DTOs\Delivery\ShanonoTrackDeliveryDTO;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class ShanonoTrackDeliveryAction
{
    public function execute(ShanonoTrackDeliveryDTO $dto): array
    {
        ...
        if (! $delivery) {
            throw new ModelNotFoundException('Delivery not found for the given identifier.');
        }
