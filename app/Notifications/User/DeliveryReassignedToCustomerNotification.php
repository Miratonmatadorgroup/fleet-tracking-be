...
class DeliveryReassignedToCustomerNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase(object $notifiable): array
    {
        return [
            ...
            'message' => "Your delivery (Tracking: {$this->delivery->tracking_number}) has been reassigned to driver {$this->driver->name}. Vehicle: {$this->vehicle}. Contact: {$this->contacts}",
