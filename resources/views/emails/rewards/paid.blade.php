                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="text-align: center; margin: 40px 0;">
                                <a href="https://useLoopFreight.com/" style="padding: 12px 24px; background-color: #2d5a3a; color: #fff; text-decoration: none; border-radius: 6px; font-size: 16px;">
                                    Go to Dashboard
                                </a>
                            </p>
                    ...
                    <tr style="background-color: #f0f0f0;">
                        <td style="padding: 20px; text-align: center; font-size: 12px; color: #888;">
                            ...
                            <a href="https://useLoopFreight.com/" style="color: #2d5a3a;">useLoopFreight.com</a>
                        </td>
                    </tr>
