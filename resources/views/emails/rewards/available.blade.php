...
<head>
    <meta charset="UTF-8">
    <title>You've Unlocked a Reward</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="margin: 0 0 20px; color: #333;">Hello {{ $name ?? 'Driver' }},</h2>
                            ...
                            <p style="margin: 0 0 20px; color: #555;">
                                You can now proceed to claim your reward from your dashboard.
                            </p>
                            ...
                            <p style="color: #999; font-size: 14px;">
                                If you think this was a mistake, kindly contact support.
                            </p>
                        </td>
                    </tr>
