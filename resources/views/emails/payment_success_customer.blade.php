                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="color: #333;">Hello {{ $delivery->customer_name }},</h2>

                            <p style="color: #555;">
                                We are glad to inform you that your payment of
                                <strong>₦{{ number_format($payment->amount, 2) }}</strong>
                                was <strong>successful</strong>.
                            </p>

                            <p style="color: #555;">
                                Your delivery request has been successfully booked.
                                You can track your delivery anytime using the tracking number below:
                            </p>
                            ...
                            <p style="color: #999; font-size: 14px;">If you did not initiate this payment, please ignore
                                this email.</p>
                        </td>
                    </tr>
