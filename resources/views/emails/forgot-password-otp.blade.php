                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="margin: 0 0 20px; color: #333;">Hello {{ $user->name }},</h2>
                            <p style="margin: 0 0 20px; color: #555;">
                                Thank you for using <strong>{{ config('app.name') }}</strong>. Your One-Time Password
                                (OTP) for resetting your password is:
                            </p>

                            <!-- OTP Box -->
                            <div
                                style="background-color: #f0f0f0; padding: 20px; border-radius: 6px; text-align: center; font-size: 24px; font-weight: bold; color: #2d5a3a;; margin: 20px 0;">
                                {{ $otp }}
                            </div>
