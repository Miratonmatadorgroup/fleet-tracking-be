                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #555;">Your payment of
                                <strong>₦{{ number_format($payment->amount, 2) }}</strong> is successful, delivery
                                request has been successfully
                                booked, and assigned to a
                                driver.</p>
