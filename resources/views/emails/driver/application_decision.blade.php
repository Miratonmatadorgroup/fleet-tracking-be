...
<head>
    <meta charset="UTF-8">
    <title>Driver Application Status</title>
</head>
                        ...
                        <td style="padding: 40px;">
                            ...
                            @if ($status === 'approved')
                                <p style="margin: 0 0 20px; color: #555;">
                                    Congratulations! Your driver application has been approved. You may now begin
                                    receiving assignments.
                                </p>
                            @else
                                <p style="margin: 0 0 20px; color: #555;">
                                    We're sorry to inform you that your driver application has been rejected. Please
