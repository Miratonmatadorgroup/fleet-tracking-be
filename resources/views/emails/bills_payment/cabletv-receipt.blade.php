...
<head>
    <meta charset="UTF-8">
    <title>Cable Tv Subscription Receipt</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #555;">Your cable tv subscription was successful.</p>

                            <h3 style="color: #421d95;;">Cable Tv Subscription Details:</h3>
                            <ul style="color: #555;">
                                <li><strong>Provider:</strong> {{ $provider }}</li>
                                <li><strong>Package:</strong> {{ $package }}</li>
                                <li><strong>Decoder Number:</strong> {{ $decoder_number }}</li>
