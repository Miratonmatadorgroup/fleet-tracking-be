...
<head>
    <meta charset="UTF-8">
    <title>Electricity Purchase Receipt</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #555;">Your electricity purchase was successful.</p>

                            <h3 style="color: #421d95;;">Electricity Purchase Details:</h3>
                            <ul style="color: #555;">
                                <li><strong>Meter Number:</strong> {{ $meter }}</li>
                                <li><strong>Disco:</strong> {{ $disco }}</li>
