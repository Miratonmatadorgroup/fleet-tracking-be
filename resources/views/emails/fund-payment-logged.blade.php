                    ...
                    <tr>
                        <td style="padding:40px;">
                            <h2 style="margin:0 0 20px;color:#333;">
                                {{ $payload['api_client'] ?? 'External Client' }} Payment Logged
                            </h2>
                            <p style="margin:0 0 20px;color:#555;">
                                A new fund payment has been logged on LoopFreight by
                                <strong>{{ $payload['api_client'] ?? 'Unknown Client' }}</strong>.
                            </p>
                            ...
                            <table width="100%" cellpadding="10" cellspacing="0"
                                ...
                                <tr style="background-color:#f9f9f9;">
                                    <td style="border:1px solid #ddd;">Total Owed</td>
                                    <td style="border:1px solid #ddd;font-weight:bold;">
                            ...
                            <p style="margin:20px 0;color:#555;">
                                Please log in to the LoopFreight Admin dashboard for details.
                            </p>
                        </td>
                    </tr>
