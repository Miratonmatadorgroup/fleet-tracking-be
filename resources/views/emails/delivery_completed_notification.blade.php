                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #555;">
                                ...
                                @elseif ($recipientType === 'driver')
                                    Delivery with tracking number <strong>{{ $delivery->tracking_number }}</strong> has
                                    been confirmed as completed by the customer. Thank you for your service.
                                @endif
                            </p>
                            ...
                            @if ($transport)
                                <h3 style="color: #2d5a3a;;">Transport Info:</h3>
                                <ul style="color: #555;">
                                    <li><strong>Type:</strong> {{ $transport->type }}</li>
                                    <li><strong>Model:</strong> {{ $transport->model }}</li>
                                    <li><strong>Registration No:</strong> {{ $transport->registration_number }}</li>
                                </ul>
                            @endif
