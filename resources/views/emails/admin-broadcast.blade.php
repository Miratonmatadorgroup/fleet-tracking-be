                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 20px; color: #555;">
                                You have a new message from <strong>{{ config('app.name') }}</strong>:
                            </p>

                            <!-- Main message box -->
                            <div
                                style="background-color: #f0f0f0; padding: 20px; border-radius: 6px; color: #333; font-size: 16px; margin-bottom: 20px;">
                                {!! nl2br(e($messageText)) !!}
                            </div>

                            <p style="margin: 0 0 20px; color: #555;">
                                For more information or to take action, visit our platform.
                            </p>
