...
<head>
    <meta charset="UTF-8">
    <title>Investor Application Status</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="margin: 0 0 20px; color: #333;">Hello {{ $investor->full_name }},</h2>

                            @if ($status === 'approved')
                                <p style="margin: 0 0 20px; color: #555;">
                                    Congratulations! Your investor application has been approved. You may now begin
                                    accessing investor features.
                                </p>
                            @else
                                <p style="margin: 0 0 20px; color: #555;">
                                    We're sorry to inform you that your investor application has been rejected. Please
