...
<head>
    <meta charset="UTF-8">
    <title>Investor Application Received</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 20px; color: #555;">
                                Thank you for your investor application! We’ve received your submission and our team
                                will reach out shortly to finalize your onboarding process.
                            </p>

                            @if ($investmentAmount)
                                <p style="font-size: 16px; margin: 0 0 20px; color: #555;">
                                    <strong>Investment Amount:</strong> ₦{{ number_format($investmentAmount, 2) }}
                                </p>
                            @endif

                            <p style="font-size: 16px; margin: 0 0 20px; color: #555;">
                                Status: <strong style="color: #421d95;;">In Review</strong>
                            </p>
