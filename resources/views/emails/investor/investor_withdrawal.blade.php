                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 20px; color: #555;">
                                Thank you for your trust in <strong>{{ config('app.name') }}</strong>.
                                We have received your investment withdrawal request.
                            </p>

                            <p style="margin: 0 0 20px; color: #555;">
                                Our team is currently processing your refund. You’ll be notified once the process is complete.
                            </p>
