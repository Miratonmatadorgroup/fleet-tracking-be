...
<head>
    <meta charset="UTF-8">
    <title>Investment Payment Successful</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 20px; color: #555;">
                                We’re excited to let you know that your investment payment of
                                <strong>₦{{ number_format($amount, 2) }}</strong> was successful!
                            </p>

                            <p style="margin: 0 0 20px; color: #555;">
                                Your account is now active and our team will keep you updated with progress and
                                opportunities.
                            </p>
