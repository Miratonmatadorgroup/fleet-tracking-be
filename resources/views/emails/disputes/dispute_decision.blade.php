                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 20px; color: #555;">
                                We are writing to inform you that your dispute titled
                            ...
                            <p style="margin: 0 0 20px; color: #555;">
                                ...
                                {{ $dispute->resolution ?? 'No resolution details provided.' }}
                            </p>
                            ...
                            <p style="color: #999; font-size: 14px;">
                                If you believe this resolution is incorrect or need further assistance, please contact
                                our support team.
                            </p>
                        </td>
                    </tr>
