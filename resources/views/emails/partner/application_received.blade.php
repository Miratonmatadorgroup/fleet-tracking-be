                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="margin: 0 0 20px; color: #333;">Hello {{ $partner->full_name ?? 'Partner' }},
                            </h2>
                            <p style="margin: 0 0 20px; color: #555;">
                                We have received your partner application. Our team will review it and notify you once a
